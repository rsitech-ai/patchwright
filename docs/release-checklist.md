...
- [x] `./script/verify.sh` passes from final source.
- [x] `./script/smoke.sh` and `./script/smoke_codex.sh` pass.
- [x] The authorized disposable GitHub App delivery/merge smoke passes; no production repository is used for qualification writes.
