...
struct DeliveryApprovalSheet: View {
    ...
    private func actionSummary(_ action: GitHubActionPayload) -> String {
        ...
        case "readyPullRequest": "Mark this exact draft pull request ready for review only if its remote head still matches the approved commit."
        case "resolveReviewThread": "Resolve only the selected review thread after GitHub confirms it belongs to this pull request and its remote head still matches the approved commit."
